...
slab.write('Pt_111.json') #we can write the atoms object to a .json file and then view it from the command line with "ase-gui" or load it into another script.
